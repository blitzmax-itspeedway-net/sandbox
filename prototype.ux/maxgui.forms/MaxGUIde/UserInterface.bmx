...
Global EDITWINDOW, DISPLAYCANVAS, MENUCANVAS, PLUSCANVAS, MAXCANVAS, PLUSTOOLIMG, MAXTOOLIMG
Global VALUEGADGET					' values get entered / selected in this gadget
Global EXPORT_TYPE					' b+ or bmax
...
'	Field activetool			' which tool bar is shown. (b+, winblit3d, etc)
	...
	Field exporttype$			' blitzplus or bmax
...
SetMinWindowSize MAINWINDOW, 320,540
...
PLUSCANVAS = CreateCanvas(0,24,96,353, MAINWINDOW)
SetGadgetLayout PLUSCANVAS,1,0,1,0
PLUSTOOLIMG = LoadImage("res.blitzplus-controls.png")
'!!MaskImage PLUSTOOLIMG, 255,0,255

MAXCANVAS = CreateCanvas(0,24,96,257, MAINWINDOW)
SetGadgetLayout MAXCANVAS,1,0,1,0
MAXTOOLIMG = LoadImage("res.blitzmax-controls.png")
'!!MaskImage MAXTOOLIMG, 255,0,255
HideGadget MAXCANVAS

EXPORT_TYPE = CreateComboBox(0, 0, 92, 21, MAINWINDOW)
SetGadgetLayout EXPORT_TYPE,1,0,1,0
AddGadgetItem(EXPORT_TYPE,"Blitz Plus")
AddGadgetItem(EXPORT_TYPE,"Blitz MAX")
'AddGadgetItem(EXPORT_TYPE,"WinBlitz3D")
SelectGadgetItem(EXPORT_TYPE, 0)
