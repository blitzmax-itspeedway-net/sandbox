...
'#
Field scaleHeight:Int, ScaleWidth:Int		'# VB Specific scaling
...
'		CloseStream ts
	...
	'------------------------------------------------------------
	Method Parse:Int()
	Local line:String, ident:String[]
	...
	Local version:String
		...
		'		form.window = New TElement( Null, WIDGET_FRAME, ident[2] )
...
Rem	
	'------------------------------------------------------------
	Method ParseForm:Int()
	Local line:String, ident:String[], gadname:String
	Local failed:Int = False
...
'				Case "ScaleWidth"
	...
	'------------------------------------------------------------
	Method ParseGadget:Int( component:TElement )
	Local line:String, ident:String[]
	Local failed:Int = False
		'# Read Params
		If Not readNextLine( line, ident ) Then Return fail_EOF()
...
Rem
	...
	Method Translate:String( gadname:String )
	...
	'# Need to check this...
	Method TwipsToPixels:Int( twips:Int )
