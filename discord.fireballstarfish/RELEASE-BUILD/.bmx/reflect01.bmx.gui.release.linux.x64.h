#ifndef DISCORD_FIREBALLSTARFISH_REFLECT01_BMX_GUI_RELEASE_LINUX_X64_H
#define DISCORD_FIREBALLSTARFISH_REFLECT01_BMX_GUI_RELEASE_LINUX_X64_H
...
#include <brl.mod/reflection.mod/.bmx/reflection.bmx.release.linux.x64.h>
int _bb_main();
