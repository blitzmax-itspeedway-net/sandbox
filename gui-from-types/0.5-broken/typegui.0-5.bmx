...
'getAttribute:int( attrib:ATTR )
	...
	'Field valid:Int = False
	Field isrestyle:Int = True			' Is a re-styling required?
	Field isrelayout:Int = True			' Is a re-layout required?
...
'	End Method
	...
	Method forward:Object( event:Int, data:Object )
		...
		Case EVENT_RESTYLE
			...
			If isrestyle; stylesheet.Apply( Self )
			isrestyle = False
		End Select
	End Method
...
'DebugLog( "#TContainer - validate()" )
	...
	Protected Method forward:Object( event:Int, data:Object )
	...
	Private Method reshape( x:Int, y:Int, w:Int, h:Int )
