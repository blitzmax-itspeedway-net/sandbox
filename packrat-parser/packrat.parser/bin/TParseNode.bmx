...
Type TParseNode Extends PNode Implements IVisitable ',IViewable
...
Private
	...
	Field named:String		' Named capture
...
Type TSearchEnumerator
	...
	Method New( node:TParseNode, criteria:Int )
		list = New TList()
		walk( node, criteria )
	End Method
	...
	Method walk( node:TParseNode, criteria:Int )
		'DebugStop
		For Local child:TParseNode = EachIn node.children
			walk( child, criteria )
		Next
		If node.kind = criteria; list.addlast( node )
	End Method
