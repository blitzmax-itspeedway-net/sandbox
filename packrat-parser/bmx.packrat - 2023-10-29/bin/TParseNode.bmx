...
Type TParseNode Implements IViewable, IVisitable
	...
	Method New( pattern:TPattern, kind:Int, text:String, start:Int, finish:Int, children:TParseNode[]=[] )
		Self.found = True
		Self.kind = kind
		Self.text = text
		Self.start = start
...
End Rem		
	...
	Method getText:String[]()
		Local data:String = text[start..finish]
		data = data.Replace("~n","\n")
